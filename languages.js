...
passive_credited_to_upstream: 'Начислено вышестоящим по цепочке:',
  ...
  tr: {
    ...
    btn_deleted: 'Silinmiş',
    btn_edit_mode: 'Düzenleme Modu',
    btn_show_hidden: 'Gizlileri Göster',
    btn_export_faucets: 'Faucetleri Dışa Aktar',
    btn_import_faucets: 'Faucetleri İçe Aktar',
    btn_mode: 'Mod',
    ...
    coming_soon_subtitle: 'Bu bölüm üzerinde zaten çalışıyoruz.<br>Abone olun - başlangıçta sizi bilgilendireceğiz.',
    ...
    coming_soon_notify_btn: 'Başlangıçta beni bilgilendir',
    coming_soon_connecting: 'Bağlanıyor...',
    coming_soon_subscribed: 'Abone oldunuz - başlangıçta bilgilendireceğiz!',
    coming_soon_notification_title: 'AirdropLab',
    coming_soon_notification_body: 'Abone oldunuz! Bölüm başladığında sizi bilgilendireceğiz ',
    coming_soon_close: 'Kapat',
    all_projects: 'Tüm Aktiviteler',
    airdrops_lotteries: 'Airdrop ve Çekilişler',
    faucets: 'Faucetler',
    mainnets: 'Mainnetler',
    testnets: 'Testnetler',
    ...
    crypto_security: 'Kriptoda Güvenlik',
    per_page: 'Sayfada:',
    ...
    by_name: '🔤 İsme göre',
    info_click_project: 'Proje adına tıklayarak detaylı bilgiyi veya "Rehber"e tıklayarak tamamlama talimatlarını görüntüleyin.',
    guest_warning: 'Hesaba giriş yapmadınız. Favoriler ve tamamlanan görevler sadece bu tarayıcıda kaydedilir.',
    ...
    activities_not_added: 'Aktiviteler eklenmedi.',
    added: 'Eklendi:',
    start: 'Başla',
    click: 'Tıkla',
    end: 'Bitir',
    ...
    logo_url: 'Logo URL',
    guide_url: 'Rehber Linki',
    cryptorank_url: 'CryptoRank Linki',
    twitter_url: 'Proje Twitter',
    referral_link: 'Referans Linki',
    short_desc: 'Kısa Açıklama',
    status: 'Durum',
    last_updated: 'Güncelleme Tarihi',
    has_daily_quests: 'Günlük Görevler Var',
    project_activities: 'Proje Aktiviteleri',
    add_activity: 'Aktivite Ekle',
    no_activities: 'Aktiviteler henüz eklenmedi.',
    activity_name: 'Aktivite Adı *',
    activity_date: 'Aktivite Tarihi (başlangıç)',
    activity_end_date: 'Bitiş Tarihi (otomatik bitiş)',
    detailed_desc: 'Detaylı Açıklama',
    instructions_placeholder: 'Tamamlama talimatları...',
    save: 'Kaydet',
    delete: 'Sil',
    ...
    question: '❓ Soru',
    other: '💬 Diğer',
    message_placeholder: 'Başvurunun özini açıklayın...',
    send: 'Gönder',
    close: 'Kapat',
  ...
  es: {
    ...
    coming_soon_title: 'Sección próximamente disponible',
    coming_soon_subtitle: 'Ya estamos trabajando en esta sección.<br>Suscríbete - te notificaremos en el lanzamiento.',
    ...
    coming_soon_feature_4: 'Acceso temprano',
    coming_soon_notify_btn: 'Notificarme en el lanzamiento',
    coming_soon_connecting: 'Conectando...',
    coming_soon_subscribed: '¡Suscrito! Te notificaremos en el lanzamiento.',
    coming_soon_notification_title: 'AirdropLab',
    coming_soon_notification_body: '¡Suscrito! Te notificaremos cuando se lance la sección ',
    ...
    listings: 'Listados',
    project_events: 'Eventos de Proyectos',
    ...
    // ============ NEWS AND TOOLS ============
    bitcoin_news: 'Noticias Bitcoin',
    defi_news: 'Noticias DeFi',
    gamefi_news: 'Noticias GameFi / Metaverse',
    ido_news: 'Noticias IDO/ICO/IFO/IEO',
    nft_news: 'Noticias NFT',
    gas_calculator: 'Calculadora de Gas',
    bridges: 'Puentes',
    wallet_checker: 'Verificador de Billetera',
    what_is_airdrop: 'Qué es un Airdrop',
    how_setup_wallet: 'Cómo configurar billetera',
    crypto_security: 'Seguridad en Cripto',
    per_page: 'Por página:',
    by_added_date: '📅 Por fecha de agregación',
    ...
    by_name: '🔤 Por nombre',
    info_click_project: 'Haz clic en el nombre del proyecto para información detallada o en "Guía" para completar.',
    guest_warning: 'No has iniciado sesión. Favoritos y tareas completadas solo se guardan en este navegador.',
    ...
    activities_not_added: 'Actividades no agregadas.',
    added: 'Agregado:',
    start: 'Comenzar',
    click: 'Clic',
    end: 'Finalizar',
    ...
    guide_url: 'Enlace de la Guía',
    cryptorank_url: 'Enlace de CryptoRank',
    ...
    no_activities: 'Aún no se agregaron actividades.',
    activity_name: 'Nombre de la Actividad *',
    activity_date: 'Fecha de Actividad (inicio)',
    activity_end_date: 'Fecha de Finalización (auto completar)',
    detailed_desc: 'Descripción Detallada',
    instructions_placeholder: 'Instrucciones de completado...',
    save: 'Guardar',
    delete: 'Eliminar',
    ...
    question: '❓ Pregunta',
    other: '💬 Otro',
    message_placeholder: 'Describe la esencia de tu solicitud...',
    send: 'Enviar',
    close: 'Cerrar',
    ...
    chat_with_user: 'Chatear con Usuario',
    chat_with_support: 'Chatear con Soporte',
    feedbacks_list: 'Retroalimentación y Sugerencias',
    ...
    loading_feedbacks: 'Cargando retroalimentación...',
    topic: 'Tema de Solicitud',
    message: 'Mensaje',
    start_new_feedback: 'Iniciar Nueva Solicitud',
    confirm_delete_chat: '¿Eliminar chat?',

...
const translations = {
  ru: {
    ...
    wof_week_stats: '📅 За неделю',
    wof_month_stats: '📅 За месяц',
    wof_all_time_stats: '📅 За все время',
    wof_earned: 'Заработано:',
    wof_spent: 'Потрачено:',
    wof_spins_count: 'Прокруток:',
    wof_all_time: '📅 Все время',
    wof_week: '📅 За неделю',
    wof_month: '📅 За месяц',
    wof_newest: '🆕 Новые',
    wof_oldest: '📜 Старые',
    wof_biggest: '💰 Большие',
    wof_free: '🆓 Бесплатные',
    wof_clear_history: '🗑️ Очистить историю',
    wof_clear_history_confirm: 'Вы уверены, что хотите очистить всю историю прокруток? Это действие нельзя отменить.',
    wof_history_cleared: 'История прокруток очищена на всех устройствах',
    // ============ TIME FORMATS ============
    just_now: 'только что',
    minutes_ago: '%s мин. назад',
    hours_ago: '%s ч. назад',
    days_ago: '%s д. назад',
    // ============ WHEEL NOTIFICATIONS ============
    wheel_won_lost: 'Колесо: выиграли %s RGT / потратили %s RGT.',
    wheel_even: 'Колесо: в ноль! Вернули %s RGT.',
...
passive_credited_to_upstream: 'Начислено вышестоящим по цепочке:',
    ...
    // ============ WHEEL OF FORTUNE ============
    wof_title_main: 'Wheel of Fortune',
    wof_title_edition: 'RGT Edition',
    wof_title: 'Wheel of Fortune — RGT Edition | AirdropLab',
    wof_subtitle: 'Крутите колесо и выигрывайте RGT!',
    wof_free_spins: 'Бесплатных прокруток',
    wof_free_spins_per_day: '3 бесплатных прокруток в день',
    wof_cost_per_spin: '5 RGT за дополнительную прокрутку',
    wof_spin_button: 'КРУТИТЬ КОЛЕСО',
    wof_spinning: 'КРУТИТСЯ...',
    wof_buy_spin: 'КУПИТЬ ПРОКРУТКУ',
    wof_insufficient_balance: 'Недостаточно RGT',
    wof_login_required: 'Войдите в аккаунт',
    wof_stats_title: 'Ваша статистика',
    wof_total_spins: 'Всего прокруток',
    wof_total_won: 'Всего выиграно',
    wof_total_lost: 'Всего потеряно',
    wof_monthly_loss: 'Потеряно в этом месяце',
    wof_leaderboard_title: 'Топ 10 победителей',
    wof_leaderboard_rank: 'Место',
    wof_leaderboard_player: 'Игрок',
    wof_leaderboard_max_win: 'Макс выигрыш',
    wof_leaderboard_total_won: 'Всего выиграно',
    wof_jackpot_title: 'Ежемесячный Jackpot',
    wof_jackpot_pool: 'Фонд Jackpot',
    wof_jackpot_draw: 'РОЗЫГРАТЬ JACKPOT',
    wof_jackpot_drawing: 'Розыгрыш...',
    wof_jackpot_winner: '🏆 Победитель Jackpot!',
    wof_result_win: '✨ Вы выиграли!',
    wof_result_lose: '💸 Вы проиграли',
    wof_result_even: '🤝 Ничья',
    wof_result_big_win: '🎉 БОЛЬШОЙ ВЫИГРЫШ!',
    wof_result_mega_win: '🎰 МЕГА ВЫИГРЫШ!',
    wof_notification_spin: 'Вы крутили колесо и выиграли {amount} RGT!',
    wof_notification_lose: 'Вы крутили колесо и потеряли {amount} RGT.',
    wof_notification_jackpot: '🏆 Поздравляем! Вы выиграли Jackpot {amount} RGT!',
    wof_history_title: 'История последних прокруток',
    wof_history_no_data: 'История пуста',
    wof_rules_title: 'Правила',
    wof_rule1: '3 бесплатных прокрутки в день',
    wof_rule2: 'Дополнительные прокрутки стоят 5 RGT каждая',
    wof_rule3: 'Награды: 1, 2, 3, 4, 10, 20, 50, 100 RGT',
    wof_rule4: 'Выше награда = ниже вероятность',
    wof_rule5: 'Вы можете выиграть меньше, чем заплатили',
    wof_paid_cost: 'Дополнительная прокрутка',
    wof_spin_free: 'СПИН (БЕСПЛАТНО)',
    wof_monthly_jackpot: '🎁 ЕЖЕМЕСЯЧНЫЙ JACKPOT',
    wof_spin_jackpot: 'Крутить Jackpot (Admin)',
    wof_tab_top: 'Топ выигрышей',
    wof_tab_history: 'История',
    wof_tab_jackpot: 'Джекпот',
    wof_lb_player: 'Игрок',
    wof_lb_maxwin: 'Лучший выигрыш',
    wof_lb_totalwon: 'Всего выиграно',
    wof_loading: 'Загрузка...',
    wof_history_empty: 'Прокруток пока нет',
    wof_how_jackpot: 'Как работает Джекпот?',
    wof_jackpot_desc: 'В конце каждого месяца админ разыгрывает джекпот из всех RGT, которые игроки проиграли на колесе. Учитываются только чистые проигрыши.',
    wof_loss_calc: 'Расчет проигрыша',
    wof_loss_calc_desc: 'Если вы потратили 5 RGT и выиграли 3 RGT → проигрыш = 2 RGT. Если вы выиграли больше, чем потратили → проигрыш = 0.',
    wof_jackpot_draw_title: 'Розыгрыш Джекпота',
    wof_participants_title: 'Участники и шансы',
    wof_jackpot_chance: 'Ваш шанс на джекпот',
    wof_chance_hint: 'На основе ваших проигрышей по сравнению с общими проигрышами за этот месяц',
    wof_chance_calc: 'Ваша формула шанса',
    wof_chance_calc_desc: 'Ваш шанс = Ваш проигрыш / Общий проигрыш всех игроков. Например, если вы проиграли 5 RGT, а всего 7 RGT → ваш шанс = 5/7 ≈ 71%.',
    wof_jackpot_tip: 'Чем больше вы проигрываете на колесе в этом месяце, тем выше ваш шанс на джекпот!',
    wof_win_chance: 'шанс победы',
    wof_wheel_title: 'Колесо фортуны',
    wof_spin_jackpot_btn: 'Крутить колесо',
    error_loading_jackpot: 'Ошибка при загрузке джекпота',
    error_loading_participants: 'Ошибка загрузки участников',
    // ============ NOTIFICATION TYPES ============
    games: '🎮 games',
    jackpot_win: '🏆 jackpot_win',
    admin_broadcast: '🛡️ admin_broadcast',
    mark_all_as_read: '✓ mark_all_as_read',
    clear_all: '🗑️ clear_all',
    wheel_spin: '🎰 wheel_spin',
    new_notification: 'NEW',
    you_won_wheel: '🎉 you_won_wheel',
...
wof_title_edition: 'RGT Edition',
wof_title: 'Wheel of Fortune — RGT Edition | AirdropLab',
wof_subtitle: 'Spin the wheel and win RGT!',
wof_free_spins: 'Free spins',
wof_free_spins_per_day: '3 free spins per day',
wof_cost_per_spin: '5 RGT per additional spin',
wof_spin_button: 'SPIN THE WHEEL',
wof_spinning: 'SPINNING...',
wof_buy_spin: 'BUY SPIN',
wof_insufficient_balance: 'Insufficient RGT',
wof_login_required: 'Login to your account',
wof_stats_title: 'Your Stats',
wof_total_spins: 'Total Spins',
wof_total_won: 'Total Won',
wof_total_lost: 'Total Lost',
wof_monthly_loss: 'Lost This Month',
wof_leaderboard_title: 'Top 10 Winners',
wof_leaderboard_rank: 'Rank',
wof_leaderboard_player: 'Player',
wof_leaderboard_max_win: 'Max Win',
wof_leaderboard_total_won: 'Total Won',
wof_jackpot_title: 'Monthly Jackpot',
wof_jackpot_pool: 'Jackpot Pool',
wof_jackpot_draw: 'DRAW JACKPOT',
wof_jackpot_drawing: 'Drawing...',
wof_jackpot_chance: 'Your Jackpot Chance',
wof_chance_hint: 'Based on your losses vs total losses this month',
wof_chance_calc: 'Your chance formula',
wof_chance_calc_desc: 'Your chance = Your loss / Total loss of all players. E.g. if you lost 5 RGT and total is 7 RGT → your chance = 5/7 ≈ 71%.',
wof_jackpot_tip: ' The more you lose on the wheel this month, the higher your jackpot chance!',
wof_win_chance: 'win chance',
wof_result_win: ' You Won!',
wof_result_lose: ' You Lost',
wof_result_even: ' Even',
wof_result_big_win: ' BIG WIN!',
wof_result_mega_win: ' MEGA WIN!',
wof_notification_spin: 'You spun the wheel and won {amount} RGT!',
wof_notification_lose: 'You spun the wheel and lost {amount} RGT.',
wof_notification_jackpot: ' Congratulations! You won the monthly jackpot: {amount} RGT!',
wof_history_title: 'Recent Spins History',
wof_history_no_data: 'History is empty',
wof_rules_title: 'Rules',
wof_rule1: '3 free spins per day',
wof_rule2: 'Extra spins cost 5 RGT each',
wof_rule3: 'Rewards: 1, 2, 3, 4, 10, 20, 50, 100 RGT',
wof_rule4: 'Higher reward = lower probability',
wof_rule5: 'You may win less than you paid',
wof_paid_cost: 'Extra spin',
wof_spin_free: 'SPIN (FREE)',
wof_monthly_jackpot: ' MONTHLY JACKPOT',
wof_spin_jackpot: 'Spin Jackpot (Admin)',
wof_tab_top: 'Top Wins',
wof_tab_history: 'History',
wof_tab_jackpot: 'Jackpot Info',
wof_lb_player: 'Player',
wof_lb_maxwin: 'Best Win',
wof_lb_totalwon: 'Total Won',
wof_loading: 'Loading...',
wof_history_empty: 'No spins yet',
wof_how_jackpot: 'How does Jackpot work?',
wof_jackpot_desc: 'At the end of each month, admin draws a jackpot from all RGT that players lost on the wheel. Only net losses are counted.',
wof_loss_calc: 'Loss calculation',
wof_loss_calc_desc: 'If you spent 5 RGT and won 3 RGT → loss = 2 RGT. If you won more than you spent → loss = 0.',
wof_jackpot_draw_title: 'Jackpot Drawing',
wof_participants_title: ' Participants & Chances',
wof_jackpot_bank: ' Total Jackpot Pool',
wof_participants_count: '{count} participants',
wof_wheel_title: ' Wheel of Fortune',
wof_spin_jackpot_btn: ' Spin Wheel',
error_loading_jackpot: 'Error loading jackpot',
    ...
    new_notification: 'NEW',
    you_won_wheel: ' You Won Wheel',
    minutes_ago: 'minutes ago',
    hours_ago: 'hours ago',
    click_for_details: 'Click for Details',
    mark_as_read: 'Mark as Read',
    // ============ WHEEL OF FORTUNE STATISTICS ============
    wof_week_stats: '📅 Last Week',
    wof_month_stats: '📅 Last Month',
    wof_all_time_stats: '📅 All Time',
    wof_earned: 'Earned:',
    wof_spent: 'Spent:',
    wof_spins_count: 'Spins:',
    wof_all_time: '📅 All Time',
    wof_week: '📅 Last Week',
    wof_month: '📅 Last Month',
    wof_newest: '🆕 Newest',
    wof_oldest: '📜 Oldest',
    wof_biggest: '💰 Biggest',
    wof_free: '🆓 Free',
    wof_clear_history: '🗑️ Clear History',
    wof_clear_history_confirm: 'Are you sure you want to clear all spin history? This action cannot be undone.',
    wof_history_cleared: 'Spin history cleared on all devices',
    // ============ TIME FORMATS ============
    just_now: 'just now',
    ...
    days_ago: '%s d ago',
    // ============ WHEEL NOTIFICATIONS ============
    wheel_won_lost: 'Wheel: won %s RGT / spent %s RGT.',
    wheel_even: 'Wheel: even! Got back %s RGT.',
    wof_stats_title: 'Your Stats',
    wof_total_spins: 'Total Spins',
    wof_total_won: 'Total Won',
    wof_total_lost: 'Total Lost',
    ...
    wof_jackpot_draw: 'DRAW JACKPOT',
    wof_jackpot_drawing: 'Drawing...',
    wof_jackpot_winner: '🏆 Jackpot Winner!',
    wof_result_win: '✨ You Won!',
    wof_result_lose: '💸 You Lost',
    wof_result_even: '🤝 Even',
    wof_result_big_win: '🎉 BIG WIN!',
    ...
    wof_notification_spin: 'You spun the wheel and won {amount} RGT!',
    wof_notification_lose: 'You spun the wheel and lost {amount} RGT.',
    wof_notification_jackpot: '🏆 Congratulations! You won the Jackpot {amount} RGT!',
    wof_history_title: 'Recent Spins History',
    wof_history_no_data: 'History is empty',
  }
};

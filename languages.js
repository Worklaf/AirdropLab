...
passive_credited_to_upstream: 'Начислено вышестоящим по цепочке:',
    ...
    // ============ WHEEL OF FORTUNE ============
    wof_title: 'Wheel of Fortune — RGT Edition',
...
passive_credited_to_upstream: 'Credited to upstream chain:',
    ...
    all_requests: 'All requests',
    my_messages: 'My messages',
    feedbacks_list: 'Feedbacks and suggestions',
    loading_feedbacks: 'Loading feedbacks...',
    close: 'Close',
    ...
    error_clearing: 'Error clearing',
    all_notifications_marked: 'All notifications marked as read',
    no_notifications: 'No notifications',
    loading_notifications: 'Loading notifications...',
    error_loading: 'Error loading',
    firestore_functions_unavailable: 'Firestore functions not available',
    are_you_sure: 'Are you sure',
    delete_notifications: 'delete',
    notifications_from_filter: 'notifications from current filter',
    all_notifications: 'All notifications',
    marked_as_read: 'Marked as read: %s notifications',
    deleted_count: 'Deleted: %s notifications',
    ...
    faucet_claim: 'Faucet',
    game_reward: 'Game',
    admin_broadcast: 'Administration',
    reward_type: 'Reward',
    newsletter: 'Newsletter',
    feedback_reply: 'Reply to message',
    click_for_details: 'Click for details',

    // ============ WIN MESSAGES ============
    congratulations: 'Congratulations!',
    you_won: 'You won',
    you_won_wheel: '🎉 You won %s RGT on the wheel!',
    wheel_even: '🤝 Wheel: even! Got back %s RGT.',
    wheel_won_lost: '😓 Wheel: won %s RGT / spent %s RGT.',
    congratulations_jackpot: '🏆 Congratulations! You won the monthly jackpot: %s RGT!',
    jackpot_winner_title: 'JACKPOT WINNER',
    jackpot_congrats: 'Congratulations! The monthly jackpot has been awarded.',
    ...
    // ============ SYSTEM MESSAGES ============
    system: 'System',
    no_unread_in_filter: 'No unread notifications in current filter',
    no_notifications_in_filter: 'No notifications in current filter',
    error_marking_notifications: 'Error marking notifications',
